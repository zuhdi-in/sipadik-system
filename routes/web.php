...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('dashboard/user')->group(function () {
        ...
        Route::get('/{id}/edit', [UserController::class, 'edit'])->middleware('user-access:admin,staff')->name('user.edit');;
        Route::put('/{id}', [UserController::class, 'update'])->middleware('user-access:admin,staff')->name('user.update');;
    ...
    Route::prefix('dashboard/surat-masuk')->group(function () {
        ...
        Route::get('preview/{id}', [SuratMasukController::class, 'previewFile'])->middleware('user-access:admin,staff')->name('surat-masuk.preview');;
    });
