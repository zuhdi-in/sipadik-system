...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-column flex-sm-row mb-4">
            <div class="d-flex">
                <h3 class="title_page">Jenis Surat</h3>
            </div>
            <div class="d-flex flex-wrap justify-content-between gap-10 mt-4 mt-lg-0 ">
                <a class="btn btn-success btn_print" href="{{ route('jenis-surat.create') }}">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <form method="POST" action="{{ route('jenis-surat.destroy', $row->id) }}">
                                        @csrf
                                        @method('DELETE')

                                        <!-- aksi untuk edit data -->
                                        <a class="dropdown-item btn btn-warning btn-sm"
                                            href="{{ route('jenis-surat.edit', $row->id) }}">
