    ...
    <div class="container-fluid">
        <div class="mb-4">
            <div class="d-flex">
                ...
                <h3 class="title_page">Form Edit Surat Keluar</h3>
            </div>
        </div>
        <div class="mb-4 pt-4">
            @if ($errors->any())
                ...
                <form method="POST" action="{{ route('surat-keluar.update', $data->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-sm-6 mb-3 mb-lg-0">
                            ...
                            <input value="{{ $data->{'tanggal_keluar'} }}" type="date" name="tanggal_keluar"
                                class="form-control" />
                        </div>

                        <div class="col-12 col-sm-6">
                            <label class="form-label">Penerima</label>
                            <input value="{{ $data->penerima }}" type="text" name="penerima" class="form-control" />
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-12 col-sm-6 mb-3 mb-lg-0">
