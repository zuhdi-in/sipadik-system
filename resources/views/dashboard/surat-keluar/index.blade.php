    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-column flex-sm-row mb-4">
            <div class="d-flex">
                ...
                <h3 class="title_page">Buku Agenda - Surat Keluar</h3>
            </div>
            <div class="d-flex flex-wrap justify-content-between gap-10 mt-4 mt-lg-0 ">
                <a class="btn btn-danger btn_print" href="{{ url('dashboard/surat-keluar/export-pdf') }}">
                    <i class="fa-regular fa-file-pdf fa-lg"></i> &nbsp Cetak Laporan
                </a>
                <a class="btn btn-success btn_print" href="{{ url('dashboard/surat-keluar/export-excel') }}">
            ...
            <table class="table table-borderless text-center custom-table align-middle" id="example" width="100%"
                ...
                <thead>
                    <tr>
                        ...
                        @endif
                        @if(auth()->check() && auth()->user()->type == 'kepala-sekolah')
                        <th style="border-top-right-radius: 20px" class="text-center" class="text-center">Berkas</th>
                        @endif
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="mt-2 d-flex justify-content-center">
                                    <a href="{{ url('dashboard/surat-keluar/preview', $row->id) }}"
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <form method="POST" action="{{ route('surat-keluar.destroy', $row->id) }}">
                                        @csrf
                                        @method('DELETE')

                                        <!-- aksi untuk edit data -->
                                        <a class="dropdown-item btn btn-warning btn-sm"
                                            href="{{ route('surat-keluar.edit', $row->id) }}">
